...
keymapFn("]w", "lua vim.diagnostic.goto_next({ severity = vim.diagnostic.severity.WARN })", { desc = "Next Warning" })
keymapFn("[w", "lua vim.diagnostic.goto_prev({ severity = vim.diagnostic.severity.WARN })", { desc = "Prev Warning" })
